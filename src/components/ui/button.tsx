  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        performance: "bg-gradient-performance text-white hover:shadow-glow-performance hover:scale-105 font-semibold",
        social: "bg-gradient-social text-white hover:shadow-glow-social hover:scale-105",
        recording: "bg-error text-white hover:bg-error/90 animate-recording-pulse",
        hero: "bg-gradient-primary text-white hover:shadow-glow-primary hover:scale-105 font-bold border border-primary-glow/30",
      },
      size: {
